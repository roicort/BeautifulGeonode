...
RUN mkdir -p /usr/src/beautiful_geonode
...
COPY src /usr/src/beautiful_geonode/
WORKDIR /usr/src/beautiful_geonode
...
RUN chmod +x /usr/src/beautiful_geonode/tasks.py \
    && chmod +x /usr/src/beautiful_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/beautiful_geonode/entrypoint.sh
