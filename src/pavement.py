...
try:
    from beautiful_geonode.local_settings import *
except ImportError:
    from beautiful_geonode.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf beautiful_geonode/development.db")
    sh("rm -rf beautiful_geonode/uploaded/*")
    _configure_data_dir()
